package com.datamaking.spark.dataframe
...
object create_first_apache_spark_dataframe {
  def main(args: Array[String]): Unit = {
    println("Application Started .....")
    val spark = SparkSession
      .builder()
      .appName(name = "Create First Spark DataFrame")
      .master(master = "local")
      .getOrCreate()
    ...
    users_df_2.show ( numRows = 3, truncate = true)
